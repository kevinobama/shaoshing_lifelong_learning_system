...
use App\Http\Requests\Backend\CreateRolesRequest;
use App\Http\Requests\Backend\UpdateRolesRequest;
use App\Repositories\Backend\RolesRepository;
...
class RolesController extends AppBaseController
{
    ...
    public function edit($id)
    {
        ...
        return view('backend.roles.edit')->with('roles', $roles);
    }
